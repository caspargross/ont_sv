...
RUN curl -s https://packagecloud.io/install/repositories/github/git-lfs/script.deb.sh | bash && apt update && apt install -y git git-lfs libcunit1 libhdf5-100 libopenblas-base cmake libcunit1-dev curl libhdf5-dev libopenblas-dev parallel
